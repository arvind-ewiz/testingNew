  ...
  <tr>
    ...
    <table width="700" border="0" align="center" cellpadding="2" cellspacing="2">
        ...
        <tr>
		  ...
		  {
           ?>
          <form name="sample" method="post" action="formsubmit.php?mode=add">
            <table width="500" border="1" align="center" cellpadding="2" cellspacing="2">
              ...
              <tr>
                <td>Mob No</td>
                <td><input name="mobno" type="text" id="mobno"></td>
              </tr>
              <tr>
              <td><input type="submit" name="Submit" value="Save Data"></td>
             <!--td><strong><a href="javascript:valid_form()">Save Data</a></strong></td-->
              </tr>
            </table>
          </form>
          <?php       
        ...
        <form name="form1" method="post" action="formsubmit.php?mode=update">
            <table width="500" border="1" align="center" cellpadding="2" cellspacing="2">
              ...
              <tr>
                <td>Mob No</td>
                <td><input name="mobno" type="text" id="mobno" value="<?php echo $mobno; ?>"></td>
              </tr>
              <tr>
