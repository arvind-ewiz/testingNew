...
function valid_form ()
{
    ...
    if (document.registration.uname.value=="Enter User Name")
    {
...
<legend><strong>Registration Form</strong></legend>
  ...
  <form name="registration" method="POST" action="admin1.php" onsubmit="return valid_form();">
 ...
 <input type="submit" value="Register" style="margin:0 0 0 70">
